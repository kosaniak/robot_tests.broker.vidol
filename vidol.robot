...
Пошук тендера у разі наявності змін
  ...
  Run Keyword If   ${status}   vidol.Пошук тендера по ідентифікатору   ${user_name}   ${auction_id}
...
Завантажити документ
  ...
  vidol.Завантажити документ в тендер з типом   ${user_name}   ${auction_id}   ${file_path}
...
Завантажити ілюстрацію
  [Arguments]   ${user_name}   ${auction_id}   ${file_path}
  vidol.Завантажити документ в тендер з типом   ${user_name}   ${auction_id}   ${file_path}   illustration
...
Оновити сторінку з об'єктом МП
  [Arguments]   ${user_name}   ${asset_id}
  vidol.Пошук об’єкта МП по ідентифікатору   ${user_name}   ${asset_id}
...
Завантажити ілюстрацію в об'єкт МП
  ...
  vidol.Завантажити документ в об'єкт МП з типом   ${user_name}   ${asset_id}   ${file_path}   illustration
...
Оновити сторінку з лотом
  ...
  vidol.Пошук лоту по ідентифікатору   ${user_name}   ${lot_id}
...
Завантажити ілюстрацію в лот
  [Arguments]   ${user_name}   ${lot_id}   ${file_path}
  vidol.Завантажити документ в лот з типом   ${user_name}   ${lot_id}   ${file_path}   illustration
...
Активувати контракт
  ...
  vidol.Пошук контракту по ідентифікатору   ${user_name}   ${contract_id}
   Wait Until Keyword Succeeds   6 x   60 s   Run Keywords
  ...   Reload Page
